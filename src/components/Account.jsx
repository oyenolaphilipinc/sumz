...
export default function Account() {
  ...
  return (
    ...
    <Navbar
      ...
      className="border w-[400px] sm:w-[450px] md:w-[500px] lg:w-[550px] xl:w-[600px] 
    ...
    <div className="mt-[12vh] mx-auto border stay w-[400px] bg-[#23242a]  border-t-white py-12 flex justify-around">
